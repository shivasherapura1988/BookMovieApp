...
class Header extends Component {
	...
	loginClickHandler = () => {
		...
		let that = this;
		//access token and authenticate user.
	...
	render() {
		return ( <
...

			{
				...
				onChange = {
					this.inputLoginPasswordChangeHandler
				}
				/> <
				FormHelperText className = {
						this.state.loginPasswordRequired
					} >
					<
					span className = "red" > required < /span> <
					/FormHelperText> <
...

			{
				...
				onChange = {
					this.inputFirstNameChangeHandler
				}
				/> <
				FormHelperText className = {
				...
				onChange = {
					this.inputLastNameChangeHandler
				}
				/> <
				FormHelperText className = {
				...
				onChange = {
					this.inputContactChangeHandler
				}
				/> <
				FormHelperText className = {
